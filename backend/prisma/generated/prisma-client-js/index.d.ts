...
/**
   ...
   * `prisma.urls`: Exposes CRUD operations for the **Urls** model.
    ...
    * ```
    */
  get urls(): Prisma.UrlsDelegate<GlobalReject>;
}
  ...
  */
  ...
  export type UrlsAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<UrlsOrderByWithRelationInput>
    /**
  ...
  export type UrlsGroupByArgs = {
    where?: UrlsWhereInput
    orderBy?: Enumerable<UrlsOrderByWithAggregationInput>
    by: Array<UrlsScalarFieldEnum>
  ...
  type GetUrlsGroupByPayload<T extends UrlsGroupByArgs> = PrismaPromise<
    Array<
      PickArray<UrlsGroupByOutputType, T['by']> &
        {
  ...
  export type UrlsSelect = {
    id?: boolean
    original_url?: boolean
    route_url?: boolean
  }

  export type UrlsGetPayload<
    S extends boolean | null | undefined | UrlsArgs,
    U = keyof S
      > = S extends true
        ? Urls
    : S extends undefined
    ? never
    : S extends UrlsArgs | UrlsFindManyArgs
    ?'include' extends U
    ? Urls 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Urls ? Urls[P] : never
  } 
    : Urls
  : Urls


  type UrlsCountArgs = Merge<
    Omit<UrlsFindManyArgs, 'select' | 'include'> & {
      select?: UrlsCountAggregateInputType | true
    }
  >

  export interface UrlsDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends UrlsFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, UrlsFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Urls'> extends True ? CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>> : CheckSelect<T, Prisma__UrlsClient<Urls | null >, Prisma__UrlsClient<UrlsGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends UrlsFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, UrlsFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Urls'> extends True ? CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>> : CheckSelect<T, Prisma__UrlsClient<Urls | null >, Prisma__UrlsClient<UrlsGetPayload<T> | null >>
     ...
     * 
    **/
    findMany<T extends UrlsFindManyArgs>(
      args?: SelectSubset<T, UrlsFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Urls>>, PrismaPromise<Array<UrlsGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends UrlsCreateArgs>(
      args: SelectSubset<T, UrlsCreateArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends UrlsCreateManyArgs>(
      args?: SelectSubset<T, UrlsCreateManyArgs>
     ...
     * 
    **/
    delete<T extends UrlsDeleteArgs>(
      args: SelectSubset<T, UrlsDeleteArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>
     ...
     * 
    **/
    update<T extends UrlsUpdateArgs>(
      args: SelectSubset<T, UrlsUpdateArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends UrlsDeleteManyArgs>(
      args?: SelectSubset<T, UrlsDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends UrlsUpdateManyArgs>(
      args: SelectSubset<T, UrlsUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends UrlsUpsertArgs>(
      args: SelectSubset<T, UrlsUpsertArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>

    /**
     * Find one Urls that matches the filter or throw
     ...
     * })
    **/
    findUniqueOrThrow<T extends UrlsFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, UrlsFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends UrlsFindFirstOrThrowArgs>(
      args?: SelectSubset<T, UrlsFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__UrlsClient<Urls>, Prisma__UrlsClient<UrlsGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends UrlsAggregateArgs>(args: Subset<T, UrlsAggregateArgs>): PrismaPromise<GetUrlsAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, UrlsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUrlsGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   */
  export class Prisma__UrlsClient<T> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  /**
   * Urls base type for findUnique actions
   */
  export type UrlsFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Urls
     * 
    **/
    select?: UrlsSelect | null
    /**
   ...
   * Urls: findUnique
   */
  export interface UrlsFindUniqueArgs extends UrlsFindUniqueArgsBase {
   /**
  ...
  /**
   * Urls base type for findFirst actions
   */
  export type UrlsFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Urls
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<UrlsScalarFieldEnum>
  }

  /**
   * Urls: findFirst
   */
  export interface UrlsFindFirstArgs extends UrlsFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   * Urls createMany
   */
  export type UrlsCreateManyArgs = {
    /**
     * The data used to create many Urls.
     * 
    **/
    data: Enumerable<UrlsCreateManyInput>
   ...
   * Urls updateMany
   */
  export type UrlsUpdateManyArgs = {
    /**
   ...
   * Urls deleteMany
   */
  export type UrlsDeleteManyArgs = {
    /**
     * Filter which Urls to delete
     * 
    **/
   ...
   */
  export type UrlsFindUniqueOrThrowArgs = UrlsFindUniqueArgsBase
      

  /**
   * Urls: findFirstOrThrow
   */
  export type UrlsFindFirstOrThrowArgs = UrlsFindFirstArgsBase
      

  /**
   * Urls without action
   */
  export type UrlsArgs = {
    /**
     * Select specific fields to fetch from the Urls
     * 
    **/
  ...
  export type UrlsWhereInput = {
    AND?: Enumerable<UrlsWhereInput>
    OR?: Enumerable<UrlsWhereInput>
    NOT?: Enumerable<UrlsWhereInput>
    id?: IntFilter | number
    original_url?: StringFilter | string
    route_url?: StringFilter | string
  }
  ...
  export type UrlsWhereUniqueInput = {
    id?: number
    route_url?: string
  }
  ...
  export type UrlsScalarWhereWithAggregatesInput = {
    AND?: Enumerable<UrlsScalarWhereWithAggregatesInput>
    OR?: Enumerable<UrlsScalarWhereWithAggregatesInput>
    NOT?: Enumerable<UrlsScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    original_url?: StringWithAggregatesFilter | string
    route_url?: StringWithAggregatesFilter | string
  }
  ...
  export type UrlsUpdateInput = {
    ...
    route_url?: StringFieldUpdateOperationsInput | string
  }
